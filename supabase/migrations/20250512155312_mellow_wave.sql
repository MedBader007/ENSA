...
CREATE TABLE settings (
    ...
    school_name VARCHAR(255) NOT NULL DEFAULT 'ENSA Kénitra',
    school_email VARCHAR(255) NOT NULL DEFAULT 'contact@ensak.ma',
    school_phone VARCHAR(100) NOT NULL DEFAULT '+212 537 374 000',
    school_website VARCHAR(255) NOT NULL DEFAULT 'https://www.ensak.ma',
